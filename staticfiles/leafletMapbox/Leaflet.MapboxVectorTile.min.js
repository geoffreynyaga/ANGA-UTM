...
})(
  {
        ...
        (function(r) {
          ...
          (e.exports = i),
            ...
            (i.prototype.readUInt64 = function() {
              var t = this.buf.readUInt64LE(this.pos);
              return (this.pos += 8), t;
            }),
            ...
            (i.prototype.readVarint = function() {
              var t = this.pos;
              return this.buf[t] <= 127
                ? (this.pos++, this.buf[t])
                : this.buf[t + 1] <= 127
                ? ((this.pos += 2),
                  (127 & this.buf[t]) | (this.buf[t + 1] << 7))
                : this.buf[t + 2] <= 127
                ? ((this.pos += 3),
                  (127 & this.buf[t]) |
                    ((127 & this.buf[t + 1]) << 7) |
                ...
                ? ((this.pos += 5),
                  ((127 & this.buf[t]) |
                    ...
                    ((127 & this.buf[t + 2]) << 14) |
                    (this.buf[t + 3] << 21)) +
                    268435456 * this.buf[t + 4])
                : (this.skip(i.Varint), 0);
            }),
            (i.prototype.readSVarint = function() {
            ...
            (i.prototype.readString = function() {
              for (
                ...
                if (r[i] <= 127) s += e(r[i++]);
                  ...
                  if (r[i] <= 191)
                    throw new Error("Invalid UTF-8 codepoint: " + r[i]);
                  if (r[i] <= 223) s += e(((31 & r[i++]) << 6) | (63 & r[i++]));
                  else if (r[i] <= 239)
                    s += e(
                      ((31 & r[i++]) << 12) |
                        ((63 & r[i++]) << 6) |
            ...
            (i.prototype.readBuffer = function() {
              var t = this.readVarint(),
                e = this.buf.subarray(this.pos, this.pos + t);
              return (this.pos += t), e;
            }),
            (i.prototype.readPacked = function(t) {
              for (
                var e = this.readVarint(), r = this.pos + e, i = [];
                this.pos < r;
            ...
            (i.prototype.writeTag = function(t, e) {
              this.writeVarint((t << 3) | e);
            }),
            (i.prototype.realloc = function(t) {
              for (var e = this.buf.length; e < this.pos + t; ) e *= 2;
            ...
            (i.prototype.writePacked = function(t, e, r) {
              if (r.length) {
                for (var n = new i(), s = 0; s < r.length; s++)
                  n["write" + t](r[s]);
                var o = n.finish();
                this.writeTag(e, i.Packed), this.writeBuffer(o);
              }
            }),
            ...
            (i.prototype.writeTaggedUInt32 = function(t, e) {
              this.writeTag(t, i.Int32), this.writeUInt32(e);
            }),
            (i.prototype.writeVarint = function(t) {
              if (((t = Number(t)), isNaN(t) && (t = 0), 127 >= t))
                this.realloc(1), (this.buf[this.pos++] = t);
              else if (16383 >= t)
                this.realloc(2),
                  (this.buf[this.pos++] = 128 | ((t >>> 0) & 127)),
                  (this.buf[this.pos++] = 0 | ((t >>> 7) & 127));
              else if (33554431 >= t)
                this.realloc(3),
                  (this.buf[this.pos++] = 128 | ((t >>> 0) & 127)),
                  (this.buf[this.pos++] = 128 | ((t >>> 7) & 127)),
                  (this.buf[this.pos++] = 0 | ((t >>> 14) & 127));
              else if (268435455 >= t)
                this.realloc(4),
                  (this.buf[this.pos++] = 128 | ((t >>> 0) & 127)),
                  (this.buf[this.pos++] = 128 | ((t >>> 7) & 127)),
                  (this.buf[this.pos++] = 128 | ((t >>> 14) & 127)),
                  (this.buf[this.pos++] = 0 | ((t >>> 21) & 127));
              else
                for (; t > 0; ) {
                  var e = 127 & t;
                  (t = Math.floor(t / 128)),
            ...
            (i.prototype.writeTaggedVarint = function(t, e) {
              this.writeTag(t, i.Varint), this.writeVarint(e);
            }),
            (i.prototype.writeSVarint = function(t) {
              t >= 0 ? this.writeVarint(2 * t) : this.writeVarint(-2 * t - 1);
            }),
            (i.prototype.writeTaggedSVarint = function(t, e) {
              this.writeTag(t, i.Varint), this.writeSVarint(e);
            }),
            (i.prototype.writeBoolean = function(t) {
              this.writeVarint(Boolean(t));
            }),
            (i.prototype.writeTaggedBoolean = function(t, e) {
              this.writeTaggedVarint(t, Boolean(e));
            }),
            ...
            (i.prototype.writeTaggedString = function(t, e) {
              this.writeTag(t, i.String), this.writeString(e);
            }),
            ...
            (i.prototype.writeTaggedFloat = function(t, e) {
              this.writeTag(t, i.Int32), this.writeFloat(e);
            }),
            ...
            (i.prototype.writeTaggedDouble = function(t, e) {
              this.writeTag(t, i.Int64), this.writeDouble(e);
            }),
            (i.prototype.writeBuffer = function(t) {
              var e = t.length;
              this.writeVarint(e),
                this.realloc(e),
                t.copy(this.buf, this.pos),
                (this.pos += e);
            }),
            (i.prototype.writeTaggedBuffer = function(t, e) {
              this.writeTag(t, i.String), this.writeBuffer(e);
            }),
            (i.prototype.writeMessage = function(t, e) {
              var r = e.finish();
              this.writeTag(t, i.Message), this.writeBuffer(r);
            });
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((o = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    (e += o + f >= 1 ? c / h : c * Math.pow(2, 1 - f)),
                    e * h >= 2 && (o++, (h /= 2)),
                    o + f >= l
                      ? ((a = 0), (o = l))
                      : o + f >= 1
                      ? ((a = (e * h - 1) * Math.pow(2, n)), (o += f))
    ...
    5: [
      function(t, e, r) {
        ...
        function i(t, e) {
          for (
            this.layers = {}, this._buffer = t, e = e || t.length;
            t.pos < e;
            ...
            var r = t.readVarint(),
              i = r >> 3;
            if (3 == i) {
              var n = this.readLayer();
              n.length && (this.layers[n.name] = n);
            } else t.skip(r);
          }
        }
        var n = t("./vectortilelayer");
        (e.exports = i),
          (i.prototype.readLayer = function() {
            var t = this._buffer,
              e = t.readVarint(),
              r = t.pos + e,
              i = new n(t, r);
      ...
      function(t, e, r) {
        ...
        function i(t, e, r, i, n) {
          for (
            ...
            var s = t.readVarint(),
              o = s >> 3;
            if (1 == o) this._id = t.readVarint();
            else if (2 == o)
              for (var a = t.readVarint(), h = t.pos + a; t.pos < h; ) {
                var u = i[t.readVarint()],
                  l = n[t.readVarint()];
                this.properties[u] = l;
              }
            else
              3 == o
                ? (this.type = t.readVarint())
                : 4 == o
                ? ((this._geometry = t.pos), t.skip(s))
                : t.skip(s);
          }
        }
        var n = t("point-geometry");
        (e.exports = i),
      ...
      function(t, e, r) {
        ...
        function i(t, e) {
          (this.version = 1),
            ...
            (this._features = []);
          var r, i;
          for (e = e || t.length; t.pos < e; )
            (r = t.readVarint()),
              (i = r >> 3),
              15 === i
                ? (this.version = t.readVarint())
                : 1 === i
                ? (this.name = t.readString())
                : 5 === i
                ? (this.extent = t.readVarint())
                : 2 === i
                ? (this.length++, this._features.push(t.pos), t.skip(r))
                : 3 === i
                ? this._keys.push(t.readString())
                : 4 === i
                ? this._values.push(this.readFeatureValue())
                : t.skip(r);
        }
        var n = t("./vectortilefeature.js");
        (e.exports = i),
          (i.prototype.readFeatureValue = function() {
            for (
              var t,
                e,
                r = this._buffer,
              ...
              if (((t = r.readVarint()), (e = t >> 3), 1 == e))
                i = r.readString();
              else {
                if (2 == e) throw new Error("read float");
                if (3 == e) i = r.readDouble();
                else if (4 == e) i = r.readVarint();
                else {
                  if (5 == e) throw new Error("read uint");
                  6 == e
                    ? (i = r.readSVarint())
                    : 7 == e
                    ? (i = Boolean(r.readVarint()))
                    : r.skip(t);
                }
              }
            return i;
          ...
          (i.prototype.feature = function(t) {
            if (0 > t || t >= this._features.length)
              throw new Error("feature index out of bounds");
            this._buffer.pos = this._features[t];
            var e = this._buffer.readVarint() + this._buffer.pos;
            return new n(
              this._buffer,
              e,
              this.extent,
      ...
      function(t, e, r) {
        function n(t, e, r, i, n) {
          ...
          (this.mvtLayer = t),
            ...
            (this.selected = !1),
            (this.divisor = e.extent / r.tileSize),
            (this.extent = e.extent),
            (this.tileSize = r.tileSize),
            (this.tiles = {}),
            (this.style = n),
            this.addTileFeature(e, r);
          var a = this;
          this.map.on("zoomend", function() {
            ...
            n &&
              n.dynamicLabel &&
              "function" == typeof n.dynamicLabel &&
              (this.dynamicLabel = this.mvtSource.dynamicLabel.createFeature(
                this
              )),
            s(a);
        }
        function s(t) {
          ...
          if (e && e.ajaxSource && "function" == typeof e.ajaxSource) {
            var r = e.ajaxSource(t);
            r &&
              h.getJSON(r, function(e, r, i) {
        ...
        function a(t) {
          var e = t.tiles,
            r = t.mvtLayer;
          for (var i in e) {
            var n = parseInt(i.split(":")[0]),
              s = t.map.getZoom();
            n === s && r.redrawTile(i);
          }
        }
        var h = t("./MVTUtil"),
          u = t("./StaticLabel/StaticLabel.js");
        (e.exports = n),
          (n.prototype._setStyle = function(t) {
          ...
          (n.prototype.draw = function(t) {
            var e = this.tiles[t],
              ...
              n = t
                ...
                .slice(1, 3)
                .join(":");
            if (((i.canvas = this.mvtLayer._tiles[n]), this.selected))
              var s = this.style.selected || this.style;
            else var s = this.style;
            switch (r.type) {
              case 1:
                if (
                  (this._drawPoint(i, r.coordinates, s),
                  !this.staticLabel &&
                    "function" == typeof this.style.staticLabel)
                ) {
                  if (this.style.ajaxSource && !this.ajaxData) break;
                  this._drawStaticLabel(i, r.coordinates, s);
                }
                break;
              case 2:
                this._drawLineString(i, r.coordinates, s);
                break;
              case 3:
                this._drawPolygon(i, r.coordinates, s);
                break;
              default:
                throw new Error("Unmanaged type: " + r.type);
            }
          }),
          (n.prototype.getPathsForTile = function(t) {
            return this.tiles[t].paths;
          }),
          (n.prototype.addTileFeature = function(t, e) {
            var r = this.map.getZoom();
            e.zoom == r &&
              (this.clearTileFeatures(r),
              (this.tiles[e.id] = { ctx: e, vtf: t, paths: [] }));
          }),
          (n.prototype.clearTileFeatures = function(t) {
            for (var e in this.tiles)
              e.split(":")[0] != t && delete this.tiles[e];
          }),
          ...
          (n.prototype.select = function() {
            ...
            t &&
              t.staticLabel &&
              !t.staticLabel.selected &&
              t.staticLabel.select();
          }),
          (n.prototype.deselect = function() {
            ...
            t &&
              t.staticLabel &&
              t.staticLabel.selected &&
              t.staticLabel.deselect();
          }),
          (n.prototype.on = function(t, e) {
            this._eventHandlers[t] = e;
          }),
          (n.prototype._drawPoint = function(t, e, r) {
            if (r && t && t.canvas) {
              var i = this.tiles[t.id],
                n = 1;
              n = "function" == typeof r.radius ? r.radius(t.zoom) : r.radius;
              var s,
              ...
              try {
                ...
                return void console.log("_drawPoint error: " + h);
              }
              s.beginPath(),
                (s.fillStyle = r.color),
                s.arc(o.x, o.y, n, 0, 2 * Math.PI),
                s.closePath(),
                s.fill(),
                r.lineWidth &&
                  r.strokeStyle &&
          ...
          (n.prototype._drawLineString = function(t, e, r) {
            if (r && t && t.canvas) {
              var n = t.canvas.getContext("2d");
              (n.strokeStyle = r.color), (n.lineWidth = r.size), n.beginPath();
              var s = [],
                o = this.tiles[t.id];
              for (var a in e) {
                var h = e[a];
                for (i = 0; i < h.length; i++) {
                  var u = (0 === i ? "move" : "line") + "To",
                    l = this._tilePoint(h[i]);
                  s.push(l), n[u](l.x, l.y);
                }
              }
              n.stroke(), n.restore(), o.paths.push(s);
            }
          }),
          (n.prototype._drawPolygon = function(t, e, r) {
            if (r && t && t.canvas) {
              var i = t.canvas.getContext("2d"),
                n = r.outline;
              "function" == typeof r.color
                ? (i.fillStyle = r.color(i))
                : (i.fillStyle = r.color),
                n && ((i.strokeStyle = n.color), (i.lineWidth = n.size)),
                i.beginPath();
              var s = [],
                o = this.tiles[t.id],
                a = this.dynamicLabel;
              a && a.addTilePolys(t, e);
              for (var h = 0, u = e.length; u > h; h++)
                for (var l = e[h], f = 0; f < l.length; f++) {
                  var c = (l[f], (0 === f ? "move" : "line") + "To"),
                    p = this._tilePoint(l[f]);
                  s.push(p), i[c](p.x, p.y);
                }
              i.closePath(), i.fill(), n && i.stroke(), o.paths.push(s);
            }
          }),
          (n.prototype._drawStaticLabel = function(t, e, r) {
            if (r && t && this.mvtLayer._map) {
              var i = this._tilePoint(e[0][0]),
                n = this._project(
                  i,
                  t.tile.x,
                  t.tile.y,
                ...
                s = L.point(n.x, n.y),
                o = this.map.unproject(s);
              (this.staticLabel = new u(this, t, o, r)),
                this.mvtLayer.featureWithLabelAdded(this);
            }
          }),
          (n.prototype.removeLabel = function() {
            this.staticLabel &&
              (this.staticLabel.remove(), (this.staticLabel = null));
          }),
          (n.prototype._project = function(t, e, r, i, n) {
            var s = e * n,
              o = r * n;
            return { x: Math.floor(t.x + s), y: Math.floor(t.y + o) };
          }),
          (n.prototype._tilePoint = function(t) {
            return new L.Point(t.x / this.divisor, t.y / this.divisor);
          }),
          (n.prototype.linkedFeature = function() {
    ...
    9: [
      function(require, module, exports) {
        function removeLabels(t) {
          for (var e = t.featuresWithLabels, r = 0, i = e.length; i > r; r++) {
            var n = e[r];
            n.removeLabel();
          }
          t.featuresWithLabels = [];
        }
        function in_circle(t, e, r, i, n) {
          var s = Math.pow(t - i, 2) + Math.pow(e - n, 2);
          ...
          var maxtimeOutMillis = timeOutMillis ? timeOutMillis : 3e3,
            ...
            interval = setInterval(function() {
              new Date().getTime() - start < maxtimeOutMillis && !condition
                ? (condition =
                    "string" == typeof testFx ? eval(testFx) : testFx())
                : condition
                ? (console.log(
                    "'waitFor()' finished in " +
        ...
        module.exports = L.TileLayer.Canvas.extend({
          ...
          _featureIsClicked: {},
          _isPointInPoly: function(t, e) {
            if (e && e.length) {
              for (var r = !1, i = -1, n = e.length, s = n - 1; ++i < n; s = i)
                ((e[i].y <= t.y && t.y < e[s].y) ||
                  (e[s].y <= t.y && t.y < e[i].y)) &&
                  t.x <
                    ((e[s].x - e[i].x) * (t.y - e[i].y)) / (e[s].y - e[i].y) +
                      e[i].x &&
                  (r = !r);
              return r;
            }
          ...
          _getDistanceFromLine: function(t, e) {
            ...
            if (e && e.length > 1) {
              t = L.point(t.x, t.y);
              for (var i = 0, n = e.length - 1; n > i; i++) {
                var s = this._projectPointOnLineSegment(t, e[i], e[i + 1]);
                s.distance <= r && (r = s.distance);
              }
            }
            return r;
          },
          _projectPointOnLineSegment: function(t, e, r) {
            var i = e.distanceTo(r);
            if (1 > i) return { distance: t.distanceTo(e), coordinate: e };
            var n =
              ((t.x - e.x) * (r.x - e.x) + (t.y - e.y) * (r.y - e.y)) /
              Math.pow(i, 2);
            if (1e-7 > n) return { distance: t.distanceTo(e), coordinate: e };
            if (n > 0.9999999)
              return { distance: t.distanceTo(r), coordinate: r };
            var s = L.point(e.x + n * (r.x - e.x), e.y + n * (r.y - e.y));
            return { distance: t.distanceTo(s), point: s };
          },
          ...
          drawTile: function(t, e, r) {
            ...
            (i.id = Util.getContextID(i)),
              this._canvasIDToFeatures[i.id] || this._initializeFeaturesHash(i),
          ...
          getCanvas: function(t) {
            var e = t.tile,
              r = this._tiles[e.x + ":" + e.y];
            if (r) return (t.canvas = r), void this.redrawTile(t.id);
            var i = this;
            waitFor(
              function() {
                return (r = i._tiles[e.x + ":" + e.y]), r ? !0 : void 0;
              },
              function() {
                (r = i._tiles[e.x + ":" + e.y]),
                  (t.canvas = r),
          ...
          parseVectorTileLayer: function(t, e) {
            ...
            (n.canvas = r._tiles[i.x + ":" + i.y]),
              this._canvasIDToFeatures[n.id]
                ? this.clearTileFeatureHash(n.id)
                : this._initializeFeaturesHash(n);
            for (var s = t.parsedFeatures, o = 0, a = s.length; a > o; o++) {
              var h = s[o];
              h.layer = t;
              var u = r.options.filter;
              if ("function" != typeof u || u(h, n) !== !1) {
                var l;
                l =
                  "function" == typeof r.options.getIDForLayerFeature
                    ? r.options.getIDForLayerFeature
                    : Util.getIDForLayerFeature;
                var f = r.options.getIDForLayerFeature(h) || o,
                  c = r.features[f],
                  p = r.options.layerOrdering;
                if (("function" == typeof p && p(h, n), c))
                  c.addTileFeature(h, n);
                else {
                  var d = r.style(h);
                  (r.features[f] = c = new MVTFeature(r, h, n, f, d)),
                    d &&
                      d.dynamicLabel &&
                      "function" == typeof d.dynamicLabel &&
                      r.featuresWithLabels.push(c);
                }
                n && n.id && r._canvasIDToFeatures[n.id].features.push(c);
              }
            }
            var p = r.options.layerOrdering;
            p &&
              (r._canvasIDToFeatures[n.id].features = r._canvasIDToFeatures[
                n.id
              ].features.sort(function(t, e) {
          ...
          setLowestCount: function(t) {
            (!this._lowestCount || t < this._lowestCount) &&
              (this._lowestCount = t);
          },
          ...
          handleClickEvent: function(t, e) {
            ...
            for (
              var s,
                o,
                a,
                h = t.layerPoint.x - n._leaflet_pos.x,
                u = t.layerPoint.y - n._leaflet_pos.y,
                l = { x: h, y: u },
                f = this._canvasIDToFeatures[t.tileID].features,
              ...
              switch (y.type) {
                case 1:
                  ...
                  for (
                    v =
                      "function" == typeof y.style.radius
                        ? y.style.radius(i)
                        : y.style.radius,
                    ...
                    in_circle(o[s][0].x, o[s][0].y, v, h, u) &&
                      ((p = y), (c = 0));
                  break;
                case 2:
                  for (
                    o = y.getPathsForTile(t.tileID), s = 0;
                    s < o.length;
                    s++
                  )
                    if (y.style) {
                      var a = this._getDistanceFromLine(l, o[s]),
                        g =
                          y.selected && y.style.selected
                            ? y.style.selected.size
                            : y.style.size;
                      a < g / 2 + this.options.lineClickTolerance &&
                        c > a &&
                        ((p = y), (c = a));
                    }
                  break;
                case 3:
                  for (
                    ...
                    this._isPointInPoly(l, o[s]) && ((p = y), (c = 0));
              }
              if (0 == c) break;
            }
            p && p.toggleEnabled && p.toggle(), (t.feature = p), e(t);
          },
          clearTile: function(t) {
            var e = t.split(":"),
              r = e[1] + ":" + e[2];
            if ("undefined" == typeof this._tiles[r])
          ...
          redrawTile: function(t) {
            ...
            if (e) {
              for (var r = e.features, i = [], n = 0; n < r.length; n++) {
                var s = r[n];
                s.selected ? i.push(s) : s.draw(t);
              }
    ...
    10: [
      function(t, e, r) {
        function i(t, e, r) {
          var i = parseInt(Math.floor(((e + 180) / 360) * (1 << r))),
            n = parseInt(
              Math.floor(
                ((1 -
                  Math.log(Math.tan(t.toRad()) + 1 / Math.cos(t.toRad())) /
                    Math.PI) /
                  2) *
                  (1 << r)
              )
        ...
        function o(t) {
          t.parsedFeatures = [];
          for (var e = t._features, r = 0, i = e.length; i > r; r++) {
            var n = t.feature(r);
            (n.coordinates = n.loadGeometry()), t.parsedFeatures.push(n);
          }
          return t;
        }
        var a = t("vector-tile").VectorTile,
          h = t("pbf"),
          u = (t("point-geometry"), t("./MVTUtil")),
          l = t("./MVTLayer");
        (e.exports = L.TileLayer.MVTSource = L.TileLayer.Canvas.extend({
          options: {
            debug: !1,
            url: "",
            getIDForLayerFeature: function() {},
          ...
          initialize: function(t) {
            L.Util.setOptions(this, t),
              ...
              "function" == typeof t.ajaxSource &&
                (this.ajaxSource = t.ajaxSource),
              (this.layerLink = t.layerLink),
              (this._eventHandlers = {}),
              (this._tilesToProcess = 0);
          },
          redraw: function(t) {
            t === !1 && (this._triggerOnTilesLoadedEvent = !1),
          ...
          onAdd: function(t) {
            ...
            t.on("click", r),
              t.on("layerremove", function(i) {
                i.layer._leaflet_id === e._leaflet_id &&
                  i.layer.removeChildLayers &&
                  (i.layer.removeChildLayers(t), t.off("click", r));
              }),
              e.addChildLayers(t),
              "function" == typeof DynamicLabel &&
                (this.dynamicLabel = new DynamicLabel(t, this, {}));
          },
          drawTile: function(t, e, r) {
            var i = {
              id: [r, e.x, e.y].join(":"),
            ...
            this._tilesToProcess < this._tilesToLoad &&
              (this._tilesToProcess = this._tilesToLoad);
            var n = (i.id = u.getContextID(i));
            (this.activeTiles[n] = i),
              this.processedTiles[i.zoom] || (this.processedTiles[i.zoom] = {}),
              this.options.debug && this._drawDebugInfo(i),
              this._draw(i);
          },
          ...
          _setVisibleLayersStyle: function(t, e) {
            for (var r in this.layers)
              this.layers[r]._tileContainer.style[t] = e;
          },
          _drawDebugInfo: function(t) {
            var e = this.options.tileSize,
              r = t.canvas.getContext("2d");
            (r.strokeStyle = "#000000"),
              (r.fillStyle = "#FFFF00"),
              r.strokeRect(0, 0, e, e),
              (r.font = "12px Arial"),
              r.fillRect(0, 0, 5, 5),
              r.fillRect(0, e - 5, 5, 5),
              r.fillRect(e - 5, 0, 5, 5),
              r.fillRect(e - 5, e - 5, 5, 5),
              r.fillRect(e / 2 - 5, e / 2 - 5, 10, 10),
              r.strokeText(
                t.zoom + " " + t.tile.x + " " + t.tile.y,
                e / 2 - 30,
                e / 2 - 10
              );
          },
          _draw: function(t) {
            var e = this;
            if (this._url) {
              var r = this.getTileUrl({ x: t.tile.x, y: t.tile.y, z: t.zoom }),
                i = new XMLHttpRequest();
              (i.onload = function() {
                if ("200" == i.status) {
                  if (!i.response) return;
                  var r = new Uint8Array(i.response),
                    o = new h(r),
                    u = new a(o);
                  ...
                  e.checkVectorTileLayers(s(u), t), n(e, t);
                }
                e.reduceTilesToProcessCount();
              }),
                (i.onerror = function() {
                  console.log("xhr error: " + i.status);
                }),
                i.open("GET", r, !0);
              var o = e.options.xhrHeaders;
              for (var u in o) i.setRequestHeader(u, o[u]);
          ...
          reduceTilesToProcessCount: function() {
            this._tilesToProcess--,
              this._tilesToProcess ||
                (this._eventHandlers.PBFLoad && this._eventHandlers.PBFLoad(),
                this._pbfLoaded());
          },
          checkVectorTileLayers: function(t, e, r) {
            var i = this;
            if (i.options.visibleLayers && i.options.visibleLayers.length > 0)
              for (var n = 0; n < i.options.visibleLayers.length; n++) {
                var s = i.options.visibleLayers[n];
                t.layers[s] && i.prepareMVTLayers(t.layers[s], s, e, r);
              }
            else
              for (var o in t.layers) i.prepareMVTLayers(t.layers[o], o, e, r);
          },
          prepareMVTLayers: function(t, e, r, i) {
            var n = this;
            n.layers[e] ||
              (n.layers[e] = n.createMVTLayer(
                e,
                t.parsedFeatures[0].type || null
              )),
              i
                ? n.layers[e].getCanvas(r, t)
                : n.layers[e].parseVectorTileLayer(t, r);
          },
          createMVTLayer: function(t, e) {
            ...
            r =
              "function" == typeof i.options.getIDForLayerFeature
                ...
                : u.getIDForLayerFeature;
            var n = {
              getIDForLayerFeature: r,
              filter: i.options.filter,
              layerOrdering: i.options.layerOrdering,
              style: i.style,
              name: t,
              asynch: !0
            };
            i.options.zIndex && (n.zIndex = i.zIndex);
            var s = new l(i, n).addTo(i.map);
            return s;
          },
          getLayers: function() {
            return this.layers;
          ...
          showLayer: function(t) {
            this.layers[t] &&
              ...
              -1 == this.options.visibleLayers.indexOf("id") &&
                this.visibleLayers.push(t)),
              this.bringToFront();
          },
          ...
          addChildLayers: function(t) {
            ...
            if (e.options.visibleLayers.length > 0)
              for (var r = 0; r < e.options.visibleLayers.length; r++) {
                var i = e.options.visibleLayers[r],
                  n = this.layers[i];
                n && t.addLayer(n);
              }
            else
          ...
          _onClick: function(t) {
            var e = this,
              r = e.options.onClick,
              n = e.options.clickableLayers,
              s = e.layers;
            if (
              ((t.tileID = i(t.latlng.lat, t.latlng.lng, this.map.getZoom())),
              n || (n = Object.keys(e.layers)),
              n && n.length > 0)
            )
              for (var o = 0, a = n.length; a > o; o++) {
                var h = n[o],
                  u = s[h];
                u &&
                  u.handleClickEvent(t, function(t) {
          ...
          setFilter: function(t, e) {
            for (var r in this.layers) {
              var i = this.layers[r];
              e
                ? r.toLowerCase() == e.toLowerCase() &&
                  ((i.options.filter = t), i.clearLayerFeatureHash())
                : ((i.options.filter = t), i.clearLayerFeatureHash());
            }
          },
          setStyle: function(t, e) {
            for (var r in this.layers) {
              var i = this.layers[r];
              e
                ? r.toLowerCase() == e.toLowerCase() && i.setStyle(t)
                : i.setStyle(t);
            }
          },
          featureSelected: function(t) {
            this.options.mutexToggle &&
              (this._selectedFeature && this._selectedFeature.deselect(),
          ...
          _pbfLoaded: function() {
            ...
            e &&
              "function" == typeof e &&
              this._triggerOnTilesLoadedEvent === !0 &&
              e(this),
    ...
    11: [
      function(t, e, r) {
        var i = (e.exports = {});
        (i.getContextID = function(t) {
          return [t.zoom, t.tile.x, t.tile.y].join(":");
        }),
          (i.getIDForLayerFeature = function(t) {
            return t.properties.id;
          }),
          (i.getJSON = function(t, e) {
            var r =
      ...
      function(t, e, r) {
        function i(t, e, r, i) {
          ...
          if (
            ...
            o && o.selected && (s.selected = !0);
          }
          n(s, t, e, r, i);
        }
        function n(t, e, r, i, n) {
          var s = e.ajaxData,
            o = (t.style = n.staticLabel(e, s)),
            a = (t.icon = L.divIcon({
              className: o.cssClass || "label-icon-text",
              html: o.html,
              iconSize: o.iconSize || [50, 50]
            }));
          (t.marker = L.marker(i, { icon: a }).addTo(t.map)),
            t.selected &&
              t.marker._icon.classList.add(
                t.style.cssSelectedClass || "label-icon-text-selected"
              ),
            t.marker.on("click", function(e) {
              t.toggle();
            }),
            t.map.on("zoomend", function(e) {
              var r = e.target.getZoom();
              t.zoom !== r && t.map.removeLayer(t.marker);
            });
        }
        t("../MVTUtil");
        (e.exports = i),
    ...
    14: [
      function(t, e, r) {
        (function(e) {
          ...
          function o(t, e) {
            if (((t = y(t, 0 > e ? 0 : 0 | v(e))), !s.TYPED_ARRAY_SUPPORT))
          ...
          function h(t, e) {
            ...
            if ("undefined" != typeof ArrayBuffer) {
              if (e.buffer instanceof ArrayBuffer) return f(t, e);
              if (e instanceof ArrayBuffer) return c(t, e);
            }
            return e.length ? p(t, e) : d(t, e);
          }
          function u(t, e) {
            var r = 0 | v(e.length);
            return (t = y(t, r)), e.copy(t, 0, 0, r), t;
          }
          function l(t, e) {
            var r = 0 | v(e.length);
            t = y(t, r);
          ...
          function c(t, e) {
            return (
              s.TYPED_ARRAY_SUPPORT
                ? (e.byteLength, (t = s._augment(new Uint8Array(e))))
                : (t = f(t, new Uint8Array(e))),
              t
            );
          }
          function p(t, e) {
                ...
                switch (a) {
                  ...
                  case 3:
                    (h = t[n + 1]),
                      ...
                      128 === (192 & h) &&
                        128 === (192 & u) &&
                        ((f = ((15 & s) << 12) | ((63 & h) << 6) | (63 & u)),
                        f > 2047 && (55296 > f || f > 57343) && (o = f));
                    break;
                  case 4:
                    (h = t[n + 1]),
                      (u = t[n + 2]),
          ...
          function F(t) {
            ...
            for (var r = "", i = 0; e > i; )
              r += String.fromCharCode.apply(String, t.slice(i, (i += Q)));
            return r;
          }
          function A(t, e, r) {
            var i = "";
          ...
          function M(t, e, r, i) {
            0 > e && (e = 65535 + e + 1);
            for (var n = 0, s = Math.min(t.length - r, 2); s > n; n++)
              t[r + n] =
                (e & (255 << (8 * (i ? n : 1 - n)))) >>> (8 * (i ? n : 1 - n));
          }
          function k(t, e, r, i) {
            0 > e && (e = 4294967295 + e + 1);
            for (var n = 0, s = Math.min(t.length - r, 4); s > n; n++)
          ...
          function V(t, e, r, i, n) {
            return (
              n || C(t, e, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
              J.write(t, e, r, i, 23, 4),
              r + 4
            );
          }
          function O(t, e, r, i, n) {
            return (
              n ||
                C(t, e, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
              J.write(t, e, r, i, 52, 8),
              r + 8
            );
          }
          function z(t) {
          ...
          function Z(t, e, r, i) {
            for (var n = 0; i > n && !(n + r >= e.length || n >= t.length); n++)
              e[n + r] = t[n];
            return n;
          }
          /*!
          ...
          var K = {};
          (s.TYPED_ARRAY_SUPPORT =
            void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : i()),
            s.TYPED_ARRAY_SUPPORT &&
          ...
          (s.prototype.slice = function(t, e) {
            ...
            (s.prototype.readUIntLE = function(t, e, r) {
              (t = 0 | t), (e = 0 | e), r || B(t, e, this.length);
            ...
            (s.prototype.writeUIntLE = function(t, e, r, i) {
              (t = +t),
                (e = 0 | e),
                (r = 0 | r),
                i || D(this, t, e, r, Math.pow(2, 8 * r), 0);
              var n = 1,
                s = 0;
            ...
            (s.prototype.fill = function(t, e, r) {
              if ((t || (t = 0), e || (e = 0), r || (r = this.length), e > r))
              ...
              if (r !== e && 0 !== this.length) {
                ...
                var i;
                if ("number" == typeof t) for (i = e; r > i; i++) this[i] = t;
                else {
                  var n = N(t.toString()),
                    s = n.length;
            ...
            (s.prototype.toArrayBuffer = function() {
              if ("undefined" != typeof Uint8Array) {
                ...
                for (
                  var t = new Uint8Array(this.length), e = 0, r = t.length;
                  r > e;
                  e += 1
                )
                  t[e] = this[e];
        ...
        !(function(t) {
          ...
          function r(t) {
            ...
            (h = "=" === t.charAt(l - 2) ? 2 : "=" === t.charAt(l - 1) ? 1 : 0),
              (u = new s((3 * t.length) / 4 - h)),
              (o = h > 0 ? t.length - 4 : t.length);
            var f = 0;
            for (i = 0, n = 0; o > i; i += 4, n += 3)
              (a =
                (e(t.charAt(i)) << 18) |
                (e(t.charAt(i + 1)) << 12) |
                (e(t.charAt(i + 2)) << 6) |
            ...
            return (
              2 === h
                ? ((a = (e(t.charAt(i)) << 2) | (e(t.charAt(i + 1)) >> 4)),
                  r(255 & a))
                : 1 === h &&
                  ((a =
                    (e(t.charAt(i)) << 10) |
          ...
          function n(t) {
            ...
            var n,
              ...
              a = t.length % 3,
              h = "";
            for (n = 0, o = t.length - a; o > n; n += 3)
              (s = (t[n] << 16) + (t[n + 1] << 8) + t[n + 2]), (h += r(s));
            switch (a) {
              case 1:
                (s = t[t.length - 1]),
                  (h += e(s >> 2)),
