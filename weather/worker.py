...
def fetch_data():
    ...
    url = (
        "http://api.wunderground.com/api/" + api_token + "/conditions/q/KE/Nairobi.json"
    )
    ...
    try:
        conn = psycopg2.connect(
            dbname="anga_utm", user="postgres", host="localhost", password="19Scazorla"
        )
        ...
        cur.execute(
            """INSERT INTO weather_reading(location,weather,wind_str,temp,humidity,precip,icon_url,observation_time)
