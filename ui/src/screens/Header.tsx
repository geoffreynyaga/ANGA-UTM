...
function Header() {
    return (
        <div className="page-header w-full flex-row flex border-2 border-black bg-red-100">
                        ...
                        <ul className="nav navbar-nav navbar-right">
                            ...
                            <li className="dropdown user-dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="/mail">
                                            <span className="badge pull-right badge-danger">
                                                42
                                            </span>
                                            Messages
                                        </a>
