                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol className="breadcrumb">
                                ...
                                <span className="pull-right">
                                    <b>
                                        {missionGeojson?.properties.application_number}
                                    </b>
                                </span>
                            </ol>
                        </nav>
                        ...
                        >
                            ...
                            <div className="panel-body">
                                ...
                                <p className="card-text">
                                    ...
                                    <span className="pull-right">
                                        <b>
                                            {missionGeojson?.properties.start_datetime.toISOString()}
                                        </b>
                                    </span>
                                </p>
                                <p className="card-text">
                        ...
                        >
                            ...
                            <div className="panel-body">
                                ...
                                <p className="card-text">
                                    ...
                                    <span className="pull-right">
                                        <b>
                                            {missionGeojson?.properties.airframe_type}
                                        </b>
                                    </span>
                                </p>
                                <p className="card-text">
