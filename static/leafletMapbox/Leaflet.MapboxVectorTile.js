(function e(t, n, r) {
...
})(
  {
        ...
        (function(Buffer) {
          ...
          Protobuf.prototype.readString = function() {
            ...
            while (p < end) {
              ...
              else if (b[p] <= 0xf7) p += 4;
              // We can't handle these codepoints in JS, so skip.
          ...
          Protobuf.prototype.skip = function(val) {
            ...
            var type = val & 0x7;
            switch (type) {
              /* varint */ case Protobuf.Varint:
                while (this.buf[this.pos++] > 0x7f);
                break;
              /* 64 bit */ case Protobuf.Int64:
                this.pos += 8;
                break;
              /* length */ case Protobuf.Message:
                var bytes = this.readVarint();
                this.pos += bytes;
                break;
              /* 32 bit */ case Protobuf.Int32:
                this.pos += 4;
                break;
              default:
    ...
    4: [
      ...
      {
        "./lib/vectortile.js": 5,
        "./lib/vectortilefeature.js": 6,
        "./lib/vectortilelayer.js": 7
      }
    ],
    5: [
      function(require, module, exports) {
      ...
      function(require, module, exports) {
        ...
        function MVTFeature(mvtLayer, vtf, ctx, id, style) {
          ...
          if (
            style &&
            style.dynamicLabel &&
            typeof style.dynamicLabel === "function"
          ) {
        ...
        function ajax(self) {
          ...
          if (
            style &&
            style.ajaxSource &&
            typeof style.ajaxSource === "function"
          ) {
        ...
        MVTFeature.prototype.draw = function(canvasID) {
          ...
          switch (vtf.type) {
            case 1: //Point
              ...
              if (
                !this.staticLabel &&
                typeof this.style.staticLabel === "function"
              ) {
        ...
        MVTFeature.prototype.select = function() {
          ...
          if (
            linkedFeature &&
            linkedFeature.staticLabel &&
            !linkedFeature.staticLabel.selected
          ) {
        ...
        MVTFeature.prototype._drawLineString = function(
          ctx,
          coordsArray,
          style
        ) {
        ...
        MVTFeature.prototype._drawStaticLabel = function(
          ctx,
          coordsArray,
          style
        ) {
         ...
         * @param tileSize
         */
        MVTFeature.prototype._project = function(
          vecPt,
          tileX,
          tileY,
          extent,
      ...
      function(require, module, exports) {
        ...
        module.exports = L.TileLayer.Canvas.extend({
          ...
          _getDistanceFromLine: function(pt, pts) {
            ...
            if (pts && pts.length > 1) {
              ...
              for (var i = 0, l = pts.length - 1; i < l; i++) {
                var test = this._projectPointOnLineSegment(
                  pt,
                  pts[i],
                  pts[i + 1]
                );
          ...
          _projectPointOnLineSegment: function(p, r0, r1) {
            ...
            var u =
              ((p.x - r0.x) * (r1.x - r0.x) + (p.y - r0.y) * (r1.y - r0.y)) /
          ...
          getCanvas: function(parentCtx) {
            ...
            waitFor(
              ...
              2000
            ); //The Timeout milliseconds.  After this, give up and move on
          },
          ...
          parseVectorTileLayer: function(vtl, ctx) {
            ...
            for (var i = 0, len = features.length; i < len; i++) {
              ...
              if (!mvtFeature) {
                ...
                self.features[uniqueID] = mvtFeature = new MVTFeature(
                  self,
                  vtf,
                  layerCtx,
                  uniqueID,
              ...
              if (layerCtx && layerCtx.id)
                self._canvasIDToFeatures[layerCtx.id]["features"].push(
                  mvtFeature
                );
            }
            ...
            if (layerOrdering) {
              ...
              self._canvasIDToFeatures[
                layerCtx.id
              ].features = self._canvasIDToFeatures[layerCtx.id].features.sort(
                function(a, b) {
            ...
            for (var i = 0; i < features.length; i++) {
              ...
              switch (feature.type) {
                ...
                case 2: //LineString
                  ...
                  for (j = 0; j < paths.length; j++) {
                    if (feature.style) {
                      var distance = this._getDistanceFromLine(
                        tilePoint,
                        paths[j]
                      );
                      var thickness =
                        feature.selected && feature.style.selected
                          ? feature.style.selected.size
                          : feature.style.size;
                      if (
                        distance <
                          thickness / 2 + this.options.lineClickTolerance &&
          ...
          var maxtimeOutMillis = timeOutMillis ? timeOutMillis : 3000, //< Default Max Timout is 3s
            ...
            interval = setInterval(function() {
              if (
                ...
                condition =
                  typeof testFx === "string" ? eval(testFx) : testFx(); //< defensive code
              } else {
                if (!condition) {
                  ...
                  typeof onReady === "string"
                    ? eval(onReady)
                    : onReady("timeout"); //< Do what it's supposed to do once the condition is fulfilled
                } else {
                  ...
                  typeof onReady === "string"
                    ? eval(onReady)
                    : onReady("success"); //< Do what it's supposed to do once the condition is fulfilled
                }
              }
        ...
        module.exports = L.TileLayer.MVTSource = L.TileLayer.Canvas.extend({
          ...
          onAdd: function(map) {
            ...
            map.on("layerremove", function(e) {
              ...
              if (
                e.layer._leaflet_id === self._leaflet_id &&
                e.layer.removeChildLayers
              ) {
          ...
          _drawDebugInfo: function(ctx) {
            ...
            g.strokeText(
              ctx.zoom + " " + ctx.tile.x + " " + ctx.tile.y,
              max / 2 - 30,
              max / 2 - 10
            );
          },
            ...
            xhr.onload = function() {
              if (xhr.status == "200") {
                ...
                if (self.map && self.map.getZoom() != ctx.zoom) {
                  console.log(
                    "Fetched tile for zoom level " +
                      ctx.zoom +
                      ". Map is at zoom level " +
                      self._map.getZoom()
                  );
                  return;
                }
          ...
          reduceTilesToProcessCount: function() {
            ...
            if (!this._tilesToProcess) {
              ...
              if (this._eventHandlers["PBFLoad"])
                this._eventHandlers["PBFLoad"]();
              this._pbfLoaded();
            }
          },
          ...
          checkVectorTileLayers: function(vt, ctx, parsed) {
            ...
            if (
              self.options.visibleLayers &&
              self.options.visibleLayers.length > 0
            ) {
          ...
          prepareMVTLayers: function(lyr, key, ctx, parsed) {
            ...
            if (!self.layers[key]) {
              ...
              self.layers[key] = self.createMVTLayer(
                key,
                lyr.parsedFeatures[0].type || null
              );
            }
          ...
          hideLayer: function(id) {
            if (this.layers[id]) {
              ...
              if (this.options.visibleLayers.indexOf("id") > -1) {
                this.visibleLayers.splice(
                  this.options.visibleLayers.indexOf("id"),
                  1
                );
              }
            }
          ...
          _pbfLoaded: function() {
            ...
            if (
              onTilesLoaded &&
              typeof onTilesLoaded === "function" &&
              this._triggerOnTilesLoadedEvent === true
            ) {
              onTilesLoaded(this);
            }
    ...
    12: [
      function(require, module, exports) {
        ...
        function init(self, mvtFeature, ctx, latLng, style) {
          ...
          if (self.selected) {
            self.marker._icon.classList.add(
              self.style.cssSelectedClass || "label-icon-text-selected"
            );
          }
        ...
        StaticLabel.prototype.select = function() {
          this.selected = true;
          this.marker._icon.classList.add(
            this.style.cssSelectedClass || "label-icon-text-selected"
          );
        ...
        StaticLabel.prototype.deselect = function() {
          this.selected = false;
          this.marker._icon.classList.remove(
            this.style.cssSelectedClass || "label-icon-text-selected"
          );
          var linkedFeature = this.mvtFeature.linkedFeature();
