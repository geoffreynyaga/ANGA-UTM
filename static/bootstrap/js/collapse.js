...
(function(global, factory) {
  ...
  EventHandler =
    EventHandler && EventHandler.hasOwnProperty("default")
      ? EventHandler["default"]
      : EventHandler;
  Manipulator =
    Manipulator && Manipulator.hasOwnProperty("default")
      ? Manipulator["default"]
      : Manipulator;
  SelectorEngine =
    SelectorEngine && SelectorEngine.hasOwnProperty("default")
  ...
  var Collapse =
    ...
    (function() {
      ...
      _proto.show = function show() {
        ...
        if (this._parent) {
          actives = makeArray(
            SelectorEngine.find(Selector.ACTIVES, this._parent)
