  ...
  var Button =
    ...
    (function() {
      ...
      _proto.toggle = function toggle() {
        ...
        var rootElement = SelectorEngine.closest(
          this._element,
  ...
  var Carousel =
    ...
    (function() {
      ...
      _proto._addTouchEventListeners = function _addTouchEventListeners() {
        ...
        makeArray(
          SelectorEngine.find(Selector$2.ITEM_IMG, this._element)
      ...
      _proto._getItemIndex = function _getItemIndex(element) {
        this._items =
          element && element.parentNode
            ? makeArray(
                SelectorEngine.find(Selector$2.ITEM, element.parentNode)
              )
            : [];
      ...
      _proto._triggerSlideEvent = function _triggerSlideEvent(
        ...
        var fromIndex = this._getItemIndex(
          SelectorEngine.findOne(Selector$2.ACTIVE_ITEM, this._element)
        );
    ...
    (function() {
      function Collapse(element, config) {
        ...
        for (var i = 0, len = toggleList.length; i < len; i++) {
          ...
          var filterElement = makeArray(SelectorEngine.find(selector)).filter(
            function(foundElem) {
      ...
      _proto.show = function show() {
        ...
        if (
          ...
          this._element.classList.contains(ClassName$3.SHOW)
        ) {
          return;
        }
        ...
        if (this._parent) {
          actives = makeArray(
            SelectorEngine.find(Selector$3.ACTIVES, this._parent)
      ...
      _proto._getParent = function _getParent() {
        ...
        makeArray(SelectorEngine.find(selector, parent)).forEach(function(
          element
        ) {
    ...
    (function() {
      ...
      _proto.toggle = function toggle() {
        if (
          ...
          this._element.classList.contains(ClassName$4.DISABLED)
        ) {
          return;
        }
      ...
      _proto.show = function show() {
        if (
          this._element.disabled ||
          this._element.classList.contains(ClassName$4.DISABLED) ||
          this._menu.classList.contains(ClassName$4.SHOW)
        ) {
          return;
        }
        ...
        if (
          "ontouchstart" in document.documentElement &&
          !makeArray(SelectorEngine.closest(parent, Selector$4.NAVBAR_NAV))
            .length
        ) {
      ...
      Dropdown.dataApiKeydownHandler = function dataApiKeydownHandler(event) {
            ...
            ? event.which === SPACE_KEYCODE ||
              (event.which !== ESCAPE_KEYCODE &&
                ((event.which !== ARROW_DOWN_KEYCODE &&
                  ...
                  SelectorEngine.closest(event.target, Selector$4.MENU)))
        ...
        var items = makeArray(
          SelectorEngine.find(Selector$4.VISIBLE_ITEMS, parent)
        ).filter(isVisible);
    ...
    (function() {
      ...
      _proto.show = function show(relatedTarget) {
        ...
        EventHandler.on(this._dialog, Event$6.MOUSEDOWN_DISMISS, function() {
          EventHandler.one(_this._element, Event$6.MOUSEUP_DISMISS, function(
            event
          ) {
      ...
      _proto._showElement = function _showElement(relatedTarget) {
        ...
        if (
          this._dialog.classList.contains(ClassName$5.SCROLLABLE) &&
          modalBody
        ) {
      ...
      _proto._setEscapeEvent = function _setEscapeEvent() {
        ...
        if (this._isShown && this._config.keyboard) {
          EventHandler.on(this._element, Event$6.KEYDOWN_DISMISS, function(
            event
          ) {
      ...
      _proto._showBackdrop = function _showBackdrop(callback) {
        ...
        var animate = this._element.classList.contains(ClassName$5.FADE)
          ? ClassName$5.FADE
          : "";
        ...
        if (this._isShown && this._config.backdrop) {
          ...
          EventHandler.on(this._element, Event$6.CLICK_DISMISS, function(
            event
          ) {
      ...
      _proto._setScrollbar = function _setScrollbar() {
        ...
        if (this._isBodyOverflowing) {
          ...
          makeArray(SelectorEngine.find(Selector$5.FIXED_CONTENT)).forEach(
            function(element) {
          ...
          makeArray(SelectorEngine.find(Selector$5.STICKY_CONTENT)).forEach(
            function(element) {
  ...
  var Tooltip =
    ...
    (function() {
      ...
      _proto.dispose = function dispose() {
        ...
        EventHandler.off(
          SelectorEngine.closest(this.element, ".modal"),
          "hide.bs.modal",
      ...
      _proto.setContent = function setContent() {
        ...
        this.setElementContent(
          SelectorEngine.findOne(Selector$6.TOOLTIP_INNER, tip),
          this.getTitle()
        );
      ...
      _proto._enter = function _enter(event, context) {
        ...
        if (
          context.getTipElement().classList.contains(ClassName$6.SHOW) ||
  ...
  var Popover =
    ...
    (function(_Tooltip) {
      ...
      _proto.setContent = function setContent() {
        ...
        this.setElementContent(
          SelectorEngine.findOne(Selector$7.TITLE, tip),
          this.getTitle()
        );
        ...
        this.setElementContent(
          SelectorEngine.findOne(Selector$7.CONTENT, tip),
          content
        );
    ...
    (function() {
      function ScrollSpy(element, config) {
        ...
        this._selector =
          ...
          (this._config.target + " ." + ClassName$8.DROPDOWN_ITEM);
        this._offsets = [];
        this._targets = [];
      ...
      _proto._activate = function _activate(target) {
        ...
        if (link.classList.contains(ClassName$8.DROPDOWN_ITEM)) {
          SelectorEngine.findOne(
            Selector$8.DROPDOWN_TOGGLE,
            SelectorEngine.closest(link, Selector$8.DROPDOWN)
          ).classList.add(ClassName$8.ACTIVE);
          link.classList.add(ClassName$8.ACTIVE);
        } else {
          // Set triggered link as active
          link.classList.add(ClassName$8.ACTIVE);
          SelectorEngine.parents(link, Selector$8.NAV_LIST_GROUP).forEach(
            function(listGroup) {
              ...
              SelectorEngine.prev(listGroup, Selector$8.NAV_ITEMS).forEach(
                function(navItem) {
    ...
    (function() {
      ...
      _proto.show = function show() {
        ...
        if (
          (this._element.parentNode &&
            this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
            this._element.classList.contains(ClassName$9.ACTIVE)) ||
          this._element.classList.contains(ClassName$9.DISABLED)
        ) {
          return;
        }
        ...
        var listElement = SelectorEngine.closest(
          this._element,
      ...
      _proto._activate = function _activate(element, container, callback) {
        ...
        var activeElements =
          ...
          (container.nodeName === "UL" || container.nodeName === "OL")
            ? SelectorEngine.find(Selector$9.ACTIVE_UL, container)
            : SelectorEngine.children(container, Selector$9.ACTIVE);
        var active = activeElements[0];
        var isTransitioning =
          callback && active && active.classList.contains(ClassName$9.FADE);
      ...
      _proto._transitionComplete = function _transitionComplete(
        ...
        if (
          element.parentNode &&
          element.parentNode.classList.contains(ClassName$9.DROPDOWN_MENU)
        ) {
          var dropdownElement = SelectorEngine.closest(
            element,
            Selector$9.DROPDOWN
          );

          if (dropdownElement) {
            makeArray(SelectorEngine.find(Selector$9.DROPDOWN_TOGGLE)).forEach(
              function(dropdown) {
