...
class NotamAirspace(gis_models.Model):
    ...
    start_day = gis_models.DateField(
    ...
    notam_file = gis_models.FileField(
    ...
    reason = gis_models.CharField(
        max_length=255, blank=True, null=True, help_text=" Reason for NOTAM"
    )
            ...
            if notam_qs or reserve_qs:
                ...
                for (
                    ...
                    if self.start_time and self.end:
                        ...
                        if (
                            notam_start < booking_time_qs_start < notam_end
                            or notam_start < booking_time_qs_end < notam_end
                        ):
