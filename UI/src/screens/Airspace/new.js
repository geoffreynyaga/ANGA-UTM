    ...
    3: [
      function (require, module, exports) {
        var URI = (function () {
            ...
            (s.prototype.toString = function () {
              ...
              (s.prototype.setRawQuery = function (e) {
                return (
                  (this.paramCache_ = null), (this.query_ = e || null), this
                );
              }),
        ...
        var html = (function (e) {
            ...
            function s(e, t, a) {
              m(t, u(e), 0, { noMoreGT: !1, noMoreEndComments: !1 }, a);
            }
            ...
            function H(t, a, n) {
              return function (r, o) {
                if (!(e.ELEMENTS[r] & e.eflags.UNSAFE))
                  return { attribs: v(r, o, t, a, n) };
        ...
        !(function (t, i) {
          ...
          function l(t, i) {
            t.hasOwnProperty("options") ||
              (t.options = t.options ? pi(t.options) : {});
          ...
          function I(t, i, e) {
            ...
            return (
              "touchstart" === i
                ? t.removeEventListener(de, n, !1)
                : "touchmove" === i
                ? t.removeEventListener(pe, n, !1)
                : "touchend" === i &&
                  (t.removeEventListener(me, n, !1),
                  t.removeEventListener(fe, n, !1)),
              this
            );
          }
          function O(t, i, n) {
            ...
            (t["_leaflet_touchstart" + n] = o),
              t.addEventListener(de, o, !1),
              ye ||
                (document.documentElement.addEventListener(de, R, !0),
                document.documentElement.addEventListener(pe, N, !0),
                document.documentElement.addEventListener(me, D, !0),
                document.documentElement.addEventListener(fe, D, !0),
                (ye = !0));
          }
          function R(t) {
            (ve[t.pointerId] = t), xe++;
          ...
          function H(t, i, e) {
            ...
            (t["_leaflet_touchend" + e] = n),
              t.addEventListener(me, n, !1),
              t.addEventListener(fe, n, !1);
          }
          function F(t, i, e) {
            function n(t) {
              var i;
            ...
            return (
              ...
              (t[Le + Pe + e] = o),
              (t[Le + "dblclick" + e] = i),
              t.addEventListener(we, n, !1),
              t.addEventListener(Pe, o, !1),
          ...
          function U(t, i) {
            var e = t[Le + we + i],
              ...
              o = t[Le + "dblclick" + i];
            return (
              t.removeEventListener(we, e, !1),
              t.removeEventListener(Pe, n, !1),
              Ri || t.removeEventListener("dblclick", o, !1),
              this
            );
          }
          function V(t) {
          ...
          function $(t, i) {
            ...
            var e = et(t);
            return (
              e.length > 0 && new RegExp("(^|\\s)" + i + "(\\s|$)").test(e)
            );
          }
          function Q(t, i) {
          ...
          function gt(t, i, e, o) {
            ...
            var r = function (i) {
              ...
              a = r;
            oe && 0 === i.indexOf("touch")
              ? A(t, i, r, s)
              : !se || "dblclick" !== i || !F || (oe && Ui)
          ...
          function It(t, i, e, n, o) {
            var s,
              ...
              h = 0;
            for (r = n + 1; r <= o - 1; r++)
              (a = Wt(t[r], t[n], t[o], !0)) > h && ((s = r), (h = a));
            h > e && ((i[s] = 1), It(t, i, e, n, s), It(t, i, e, s, o));
          }
          function Ot(t, i) {
            for (var e = [t[0]], n = 1, o = 0, s = t.length; n < s; n++)
              jt(t[n], t[o]) > i && (e.push(t[n]), (o = n));
          ...
          function Ht(t) {
            return (
              !gi(t[0]) || ("object" != typeof t[0][0] && void 0 !== t[0][0])
            );
          }
          function Ft(t) {
            return (
            ...
            for (r = 0; r < 4; r++) {
              for (
                ...
                (a = t[o]),
                  ...
                  a._code & l
                    ? h._code & l ||
                      ((c = Nt(h, a, l, i, e)), (c._code = Dt(c, i)), n.push(c))
                    : (h._code & l &&
                        ((c = Nt(h, a, l, i, e)),
                        (c._code = Dt(c, i)),
                        n.push(c)),
            ...
            switch (r.type) {
              ...
              case "MultiPoint":
                for (o = 0, s = a.length; o < s; o++)
                  (e = l(a[o])), h.push(u ? u(t, e) : new vn(e));
                return new dn(h);
              case "LineString":
              case "MultiLineString":
                return (
                  (n = Qt(a, "LineString" === r.type ? 0 : 1, l)), new Pn(n, i)
                );
              case "Polygon":
              case "MultiPolygon":
                return (
                  (n = Qt(a, "Polygon" === r.type ? 1 : 2, l)), new Ln(n, i)
                );
          ...
          function Qt(t, i, e) {
            for (var n, o = [], s = 0, r = t.length; s < r; s++)
              (n = i ? Qt(t[s], i - 1, e) : (e || $t)(t[s])), o.push(n);
            return o;
          }
          function ti(t, i) {
            return (
          ...
          function ii(t, i, e, n) {
            for (var o = [], s = 0, r = t.length; s < r; s++)
              o.push(i ? ii(t[s], i - 1, e, n) : ti(t[s], n));
            return !i && e && o.push(o[0]), o;
          }
          function ei(t, e) {
            return t.feature ? i({}, t.feature, { geometry: e }) : ni(e);
          }
          function ni(t) {
          ...
          var pi =
            ...
            yi = 0,
            xi =
              window.requestAnimationFrame || p("RequestAnimationFrame") || m,
            wi =
          ...
          (v.extend = function (t) {
            ...
            return (
              ...
              t.includes &&
                ...
                delete t.includes),
              o.options && (t.options = i(pi(o.options), t.options)),
              i(o, t),
              (o._initHooks = []),
          ...
          var Li = {
            ...
            removeEventParent: function (t) {
              return (
                this._eventParents && delete this._eventParents[n(t)], this
              );
            },
          ...
          if ("onselectstart" in document)
            ...
            (Si = function () {
              ...
              (Zi = function () {
                Me &&
                  ((document.documentElement.style[Me] = Ei), (Ei = void 0));
              });
          }
          var Ce,
            Se,
            ...
            Re = bi.extend({
              ...
              initialize: function (t, i) {
                (i = l(this, i)),
                  ...
                  this.callInitHooks(),
                  (this._zoomAnimated =
                    Te && Qi && !re && this.options.zoomAnimation),
                  this._zoomAnimated &&
                    (this._createAnimProxy(),
                    mt(this._proxy, ze, this._catchTransitionEnd, this)),
              ...
              zoomIn: function (t, i) {
                return (
                  (t = t || (Qi ? this.options.zoomDelta : 1)),
              ...
              _initLayout: function () {
                ...
                (this._fadeAnimated = this.options.fadeAnimation && Qi),
                  Q(
                    t,
                    "leaflet-container" +
                      (se ? " leaflet-touch" : "") +
              ...
              _fireDOMEvent: function (t, e, n) {
                ...
                if (
                  !t._stopped &&
                  ((n = (n || []).concat(this._findEventTargets(t, e))),
                  n.length)
                ) {
                  var s = n[0];
          ...
          var je = Ne.extend({
              ...
              addTo: function (t) {
                return (
                  Ne.prototype.addTo.call(this, t), this._expandIfNotCollapsed()
                );
              },
              onRemove: function () {
          ...
          var Ye,
            ...
            tn = bi.extend({
              ...
              enable: function () {
                this._enabled ||
                  (mt(this._dragStartTarget, Je, this._onDown, this),
                  (this._enabled = !0));
              },
              disable: function () {
                this._enabled &&
                  (tn._dragging === this && this.finishDrag(),
                  ft(this._dragStartTarget, Je, this._onDown, this),
                  (this._enabled = !1),
                  (this._moved = !1));
              },
              _onDown: function (t) {
                if (
                  ...
                  (this._startPoint = new x(i.clientX, i.clientY)),
                    ...
                    mt(document, Qe[t.type], this._onMove, this),
                    mt(document, $e[t.type], this._onUp, this);
                }
              },
              _onMove: function (t) {
              ...
              finishDrag: function () {
                ...
                for (var t in Qe)
                  ft(document, Qe[t], this._onMove, this),
                    ft(document, $e[t], this._onUp, this);
                lt(),
                  Zi(),
                  this._moved &&
                    this._moving &&
          ...
          var cn = ln.extend({
              ...
              addLayer: function (t) {
                return this.hasLayer(t)
                  ...
                  : (t.addEventParent(this),
                    cn.prototype.addLayer.call(this, t),
              ...
              removeLayer: function (t) {
                return this.hasLayer(t)
                  ? (t in this._layers && (t = this._layers[t]),
                    ...
                    cn.prototype.removeLayer.call(this, t),
            ...
            fn = mn.extend({
              ...
              _getIconUrl: function (t) {
                return (
                  fn.imagePath || (fn.imagePath = this._detectIconPath()),
                  (this.options.imagePath || fn.imagePath) +
                    mn.prototype._getIconUrl.call(this, t)
                );
              },
            ...
            gn = Ke.extend({
              ...
              addHooks: function () {
                ...
                this._draggable || (this._draggable = new tn(t, t, !0)),
                  this._draggable
                    .on(
                      {
            ...
            xn = yn.extend({
              ...
              setStyle: function (t) {
                ...
                return (
                  yn.prototype.setStyle.call(this, t), this.setRadius(i), this
                );
              },
              _project: function () {
            ...
            Pn = yn.extend({
              ...
              _convertLatLngs: function (t) {
                for (var i = [], e = Ht(t), n = 0, o = t.length; n < o; n++)
                  e
          ...
          var Ln = Pn.extend({
              ...
              _setLatLngs: function (t) {
                Pn.prototype._setLatLngs.call(this, t),
            ...
            cn.include({
              toMultiPoint: function (t) {
                ...
                return (
                  ...
                  ei(this, { type: "MultiPoint", coordinates: i })
                );
              },
              toGeoJSON: function (t) {
                var i =
                ...
                return (
                  ...
                  e
                    ? ei(this, { geometries: n, type: "GeometryCollection" })
          ...
          var zn = oi,
            ...
            Sn = Mn.extend({
              ...
              _initImage: function () {
                ...
                gi(this._url) || (this._url = [this._url]),
          ...
          var Bn = Zn.extend({
              ...
              getEvents: function () {
                var t = Zn.prototype.getEvents.call(this);
                return (
                  se && !this.options.permanent && (t.preclick = this._close), t
                );
              },
              _close: function () {
          ...
          Re.include({
            openTooltip: function (t, i, e) {
              return (
                t instanceof Bn || (t = new Bn(e).setContent(t)),
                i && t.setLatLng(i),
          ...
          var On = ln.extend({
              ...
              _initTile: function (t) {
                ...
                (t.style.width = i.x + "px"),
                  ...
                  (t.onselectstart = r),
                  (t.onmousemove = r),
                  Oi && this.options.opacity < 1 && nt(t, this.options.opacity),
                  Di && !ji && (t.style.WebkitBackfaceVisibility = "hidden");
              },
            ...
            Rn = On.extend({
              ...
              initialize: function (t, i) {
                (this._url = t),
                  ...
                  Di || this.on("tileunload", this._onTileRemove);
              },
              setUrl: function (t, i) {
                return (
              ...
              _abortLoading: function () {
                ...
                for (t in this._tiles)
                  this._tiles[t].coords.z !== this._tileZoom &&
                    ...
                    (i.onload = r),
                    (i.onerror = r),
                    i.complete || ((i.src = vi), K(i), delete this._tiles[t]));
              },
              _removeTile: function (t) {
                var i = this._tiles[t];
                if (i)
                  return (
                    Hi || i.el.setAttribute("src", vi),
                    On.prototype._removeTile.call(this, t)
                  );
              },
              _tileReady: function (t, i, e) {
                if (this._map && (!e || e.getAttribute("src") !== vi))
            ...
            Nn = Rn.extend({
              ...
              getTileUrl: function (t) {
                var i = this._tileCoordsToNwSe(t),
                  ...
                  o = n.min,
                  s = n.max,
                  r = (this._wmsVersion >= 1.3 && this._crs === hn
                    ? [o.y, o.x, s.y, s.x]
                    : [o.x, o.y, s.x, s.y]
                  ).join(","),
          ...
          (Un.create = Fn),
            (Un.pointsToPath = k),
            (bn.geometryToLayer = Jt),
            (bn.coordsToLatLng = $t),
            (bn.coordsToLatLngs = Qt),
            (bn.latLngToCoords = ti),
            (bn.latLngsToCoords = ii),
            (bn.getFeature = ei),
            (bn.asFeature = ni),
          ...
          Re.addInitHook("addHandler", "boxZoom", qn),
          ...
          Re.addInitHook("addHandler", "doubleClickZoom", Gn),
            Re.mergeOptions({
              dragging: !0,
              inertia: !ji,
          ...
          var Kn = Ke.extend({
            addHooks: function () {
              if (!this._draggable) {
                var t = this._map;
                (this._draggable = new tn(t._mapPane, t._container)),
                  this._draggable.on(
                    {
                      dragstart: this._onDragStart,
                      drag: this._onDrag,
          ...
          Re.addInitHook("addHandler", "dragging", Kn),
          ...
          Re.addInitHook("addHandler", "keyboard", Yn),
            Re.mergeOptions({
              scrollWheelZoom: !0,
          ...
          Re.addInitHook("addHandler", "scrollWheelZoom", Xn),
            Re.mergeOptions({ tap: !0, tapTolerance: 15 });
          var Jn = Ke.extend({
            addHooks: function () {
          ...
          se && !oe && Re.addInitHook("addHandler", "tap", Jn),
            Re.mergeOptions({ touchZoom: se && !ji, bounceAtZoomLimits: !0 });
          var $n = Ke.extend({
            addHooks: function () {
          ...
          Re.addInitHook("addHandler", "touchZoom", $n),
            (Re.BoxZoom = qn),
            (Re.DoubleClickZoom = Gn),
            (Re.Drag = Kn),
            (Re.Keyboard = Yn),
            (Re.ScrollWheelZoom = Xn),
            (Re.Tap = Jn),
            (Re.TouchZoom = $n),
            (Object.freeze = di),
            (t.version = "1.4.0"),
        ...
        !(function (e, t) {
          ...
          function c(t, n) {
            ...
            for (var y, x, T, j, S, V, C = new h(t); !C.eos(); ) {
              if (((y = C.pos), (T = C.scanUntil(o))))
                for (var O = 0, P = T.length; O < P; ++O)
                  (j = T.charAt(O)),
                    a(j) ? d.push(f.length) : (w = !0),
                    f.push(["text", j, y, y + 1]),
                    (y += 1),
                    "\n" === j &&
                      (function () {
                        if (g && !w) for (; d.length; ) delete f[d.pop()];
                        else d = [];
                        (g = !1), (w = !1);
                      })();
              if (!C.scan(o)) break;
              if (
                ...
                C.scan(b),
                "=" === x
                  ? ((T = C.scanUntil(m)), C.scan(m), C.scanUntil(s))
                  : "{" === x
                  ? ((T = C.scanUntil(u)), C.scan(E), C.scanUntil(s), (x = "&"))
                  : (T = C.scanUntil(s)),
                !C.scan(s))
              )
                throw new Error("Unclosed tag at " + C.pos);
              if (((S = [x, T, y, C.pos]), f.push(S), "#" === x || "^" === x))
                c.push(S);
              else if ("/" === x) {
                if (!(V = c.pop()))
                  throw new Error('Unopened section "' + T + '" at ' + y);
                if (V[1] !== T)
                  throw new Error('Unclosed section "' + V[1] + '" at ' + y);
              } else
                "name" === x || "{" === x || "&" === x
                  ? (w = !0)
                  : "=" === x && i(T);
          ...
          (h.prototype.eos = function () {
            ...
            (f.prototype.lookup = function (e) {
              ...
              if (r.hasOwnProperty(e)) n = r[e];
                ...
                for (var s, a, u, c = this, p = !1; c; ) {
                  if (e.indexOf(".") > 0)
                    for (
                      s = c.view, a = e.split("."), u = 0;
                      null != s && u < a.length;

                    )
                      u === a.length - 1 && (p = i(s, a[u]) || o(s, a[u])),
                        (s = s[a[u++]]);
            ...
            (d.prototype.renderTokens = function (e, t, n, r, i) {
              for (var o, s, a, u = "", c = 0, p = e.length; c < p; ++c)
                (a = void 0),
                  (o = e[c]),
                  (s = o[0]),
                  "#" === s
            ...
            (d.prototype.renderPartial = function (e, n, r, i) {
              if (r) {
                ...
                return null != o
                  ? this.renderTokens(this.parse(o, i), n, r, o)
                  : void 0;
              }
            }),
    ...
    6: [
      function (require, module, exports) {
        module.exports = {
          ...
          scripts: {
            test:
              "eslint src && phantomjs node_modules/mocha-phantomjs-core/mocha-phantomjs-core.js test/index.html && mocha test/docs.js",
    ...
    10: [
      function (require, module, exports) {
        ...
        (module.exports = function (e, o) {
          if (!(o = o || L.mapbox.accessToken) && config.REQUIRE_ACCESS_TOKEN)
            throw new Error(
          ...
          if (
            ...
            (s += -1 !== s.indexOf("?") ? "&access_token=" : "?access_token="),
              (s += o);
          }
          return s;
        }),
          (module.exports.tileJSON = function (e, o) {
            ...
            return (
              (s =
                e in config.TEMPLATE_STYLES
                  ? module.exports("/styles/v1/" + config.TEMPLATE_STYLES[e], o)
                  : module.exports("/v4/" + e + ".json", o)),
              0 === s.indexOf("https") && (s += "&secure"),
              s
            );
          }),
          (module.exports.style = function (e, o) {
            if (-1 === e.indexOf("mapbox://styles/"))
        ...
        module.exports = function (e, t) {
          ...
          return (
            ...
            (n.queryURL = function (e) {
              ...
              if (o) {
                if (
                  (e.types &&
                    (t(e.types)
                      ? (a += "&types=" + e.types.join())
                      : (a += "&types=" + e.types)),
                  e.country &&
                    (t(e.country)
                      ? (a += "&country=" + e.country.join())
                      : (a += "&country=" + e.country)),
                  e.bbox &&
                    (t(e.bbox)
                      ? (a += "&bbox=" + e.bbox.join())
            ...
            (n.reverseQuery = function (e, t) {
              ...
              return (
                request(n.queryURL(u), function (e, r) {
                  t(e, r);
                }),
                n
              );
        ...
        var geocoder = require("./geocoder"),
          ...
          GeocoderControl = L.Control.extend({
            ...
            _displayResults: function (t) {
              ...
              if (t.length > 5) {
                L.DomUtil.create("span", "", this._results).innerHTML =
                  "Top 5 of " + t.length + "  results";
              }
            },
            ...
            _geocode: function (t) {
              if ((L.DomEvent.preventDefault(t), "" === this._input.value))
                return this._updateSubmit();
          ...
          GridControl = L.Control.extend({
            ...
            onAdd: function (t) {
              ...
              var o = L.DomUtil.create(
                  "div",
                  "leaflet-control-grid map-tooltip"
                ),
              ...
              return (
                ...
                L.DomEvent.disableClickPropagation(o).addListener(
                  o,
                  "mousewheel",
            ...
            getData: function (t, i) {
              if (this.active()) {
                ...
                return (
                  (s = (s + a) % a),
                  (n = (n + a) % a),
                  this._getTile(e.getZoom(), s, n, function (t) {
            ...
            _update: function () {
              if (this.active()) {
                ...
                if (!(i > this.options.maxZoom || i < this.options.minZoom))
                  for (
                    var e = L.bounds(
                        t.min.divideBy(256)._floor(),
                        t.max.divideBy(256)._floor()
                      ),
                      o = this._map.options.crs.scale(i) / 256,
                      s = e.min.x;
                    s <= e.max.x;
                    s++
                  )
                    for (var n = e.min.y; n <= e.max.y; n++)
                      this._getTile(i, ((s % o) + o) % o, ((n % o) + o) % o);
              }
            },
        ...
        module.exports = {
          _loadTileJSON: function (e) {
            if ("string" == typeof e) {
              ...
              i ||
                util.warn(
                  "Warning: this implementation is loading a Mapbox Studio Classic style (" +
                    t +
                  ...
                  L.bind(function (t, s) {
                    t
                      ...
                      ? ((s.tiles = [
                        ...
                        this._setTileJSON(s),
                        this.fire("ready"))
                      : s && (this._setTileJSON(s), this.fire("ready"));
                  }, this)
                );
          ...
          LMap = L.Map.extend({
            ...
            initialize: function (t, e, o) {
              if (
                ...
                (i || (!1 !== i && this._container.offsetWidth <= 640)) &&
                  L.DomUtil.addClass(
            ...
            _updateMapFeedbackLink: function () {
              if (
                ...
                var t = this._controlContainer.getElementsByClassName(
                  "mapbox-improve-map"
                );
          ...
          ShareControl = L.Control.extend({
            ...
            _shareClick: function (t) {
              ...
              (f.href = "#"),
                ...
                L.DomEvent.addListener(v, "click", function (t) {
      ...
      function (require, module, exports) {
        ...
        var util = require("./util"),
          ...
          StyleLayer = L.TileLayer.extend({
            options: { sanitizer: require("@mapbox/sanitize-caja") },
            initialize: function (t, e) {
        ...
        var util = require("./util"),
          ...
          TileLayer = L.TileLayer.extend({
            ...
            getTileUrl: function (t) {
              ...
              if (r && this.options.format)
                return r.replace(
                  formatPattern,
                  (L.Browser.retina ? this.scalePrefix : ".") +
                    this.options.format
                );
              return L.Browser.retina && -1 !== o.indexOf("/styles/v1")
                ? r.replace("?", "@2x?")
                : r;
            },
            _update: function () {
    ...
    29: [
      function (require, module, exports) {
        ...
        function contains(n, o) {
          ...
          for (var r = 0; r < o.length; r++) if (o[r] === n) return !0;
          return !1;
        }
        var warnOnceHistory = {};
        module.exports = {
          ...
          warn: function (n) {
            warnOnceHistory[n] ||
              ("object" == typeof console &&
                ...
                ((warnOnceHistory[n] = !0), console.warn(n)));
          },
          strict: function (n, o) {
            if (typeof n !== o)
              throw new Error("Invalid argument: " + o + " expected");
          },
