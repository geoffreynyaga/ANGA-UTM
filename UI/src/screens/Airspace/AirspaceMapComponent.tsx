...
// const VectorGrid = VectorGridDefault;
...
function AirspaceMapComponent(props: Props) {
    ...
    const [geofencegeojson, setGeofenceGeojson] = useState<GeojsonType | null>(null);
    const [drawnGeoJSON, setDrawnGeoJSON] = useState<GeojsonType | null>(null);

    const [drawnGeoJSONProperties, setDrawnGeoJSONProperties] = useState<any>(null);
                                          ...
                                          >
                                              ...
                                              >
                                                  ...
                                                  <p>
                                                      ...
                                                      to:{" "}
                                                      <b> {feature.properties.end}</b>
                                                  </p>
                                                  <p>
                                                      RPAS:{" "}
                                                      <b>
                                                          {feature.properties.rpas_name}
                                                      </b>{" "}
                                                      Type:{" "}
                                                      <b>
                                                          {" "}
